...
function dsCharacter() {
  ...
  this.getSoulCost = function(fromSoulLevel) {      
      if (fromSoulLevel == this.soulLevel) return 0;
      
      var temp = 0;
      for (i = fromSoulLevel; i < this.soulLevel; i++) temp = temp + parseInt(calculateSoulCost(i));
      
      return temp;
  }
  
  this.calculateSoulCost = function(level) {
